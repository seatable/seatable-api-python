...
class SeaTable(object):
    ...
    def __str__(self):
        return 'SeaTable Object [ %s ]' % self.seatable_api.uuid
    ...
    def append_row(self, row_data=None):
        self._seatable_api.append_row(self.table_name, row_data)

    def update_row(self, row, row_data):
        self._seatable_api.update_row(self.table_name, row.get('_id'), row_data)

    def delete_row(self, row):
        self._seatable_api.delete_row(self.table_name, row.get('_id'))
